...
class AIAgent:
    ...
    def _check_compression_model_feasibility(self) -> None:
        ...
        try:
            ...
            # tool schema.  With 50+ tools that overhead can be 25-30K
            # tokens.  We must ensure threshold + headroom <= aux_context
            # or the first compression/flush request will overflow with
            # HTTP 400.
            #
